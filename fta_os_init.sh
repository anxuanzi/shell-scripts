...
echo 'net.ipv4.neigh.default.gc_stale_time=120' | tee -a /etc/sysctl.conf
echo 'net.ipv4.conf.default.arp_announce=2' | tee -a /etc/sysctl.conf
echo 'net.ipv4.conf.all.arp_announce=2' | tee -a /etc/sysctl.conf
echo 'net.ipv4.conf.lo.arp_announce=2' | tee -a /etc/sysctl.conf
...
echo 'net.ipv4.tcp_max_tw_buckets=6000' | tee -a /etc/sysctl.conf
echo 'net.ipv4.tcp_sack=1' | tee -a /etc/sysctl.conf
echo 'net.ipv4.tcp_window_scaling=1' | tee -a /etc/sysctl.conf
echo 'net.ipv4.tcp_rmem=4096 87380 4194304' | tee -a /etc/sysctl.conf
echo 'net.ipv4.tcp_wmem=4096 16384 4194304' | tee -a /etc/sysctl.conf
echo 'net.core.wmem_default=8388608' | tee -a /etc/sysctl.conf
echo 'net.core.rmem_default=8388608' | tee -a /etc/sysctl.conf
...
echo 'net.ipv4.tcp_max_orphans=3276800' | tee -a /etc/sysctl.conf
...
echo 'net.ipv4.tcp_syn_retries=1' | tee -a /etc/sysctl.conf
echo 'net.ipv4.tcp_tw_reuse=1' | tee -a /etc/sysctl.conf
echo 'net.ipv4.tcp_mem=94500000 915000000 927000000' | tee -a /etc/sysctl.conf
echo 'net.ipv4.tcp_fin_timeout=1' | tee -a /etc/sysctl.conf
