...
# ==============================================================================
# Script Name: set_time_chicago.sh
# Description: This script sets the system timezone to America/Chicago
...
msg_info "Starting timezone and chronyd configuration for America/Chicago..."
